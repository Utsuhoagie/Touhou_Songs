...
namespace Touhou_Songs.Data.Migrations
{
    ...
    [Migration("20240811174055_Add_Manual_TierListItem_Source_Relation")]
    partial class Add_Manual_TierListItem_Source_Relation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Touhou_Songs.App.TierListMaking.TierList", b =>
                {
                    ...
                    b.HasIndex("UserProfileId")
                        .HasDatabaseName("ix_tier_lists_user_profile_id");
            ...
            modelBuilder.Entity("Touhou_Songs.App.TierListMaking.TierListItem", b =>
                {
                    ...
                    b.Property<int?>("OfficialGameId")
                        .HasColumnType("integer")
                        .HasColumnName("official_game_id");
                    ...
                    b.HasIndex("ArrangementSongId")
                        .HasDatabaseName("ix_tier_list_items_arrangement_song_id");

                    b.HasIndex("OfficialGameId")
                        .HasDatabaseName("ix_tier_list_items_official_game_id");
            ...
            modelBuilder.Entity("Touhou_Songs.App.TierListMaking.TierList", b =>
                {
                    b.HasOne("Touhou_Songs.App.UserProfile.UserProfile", null)
                        ...
                        .HasConstraintName("fk_tier_lists_user_profiles_user_profile_id");
                });
            ...
            modelBuilder.Entity("Touhou_Songs.App.TierListMaking.TierListItem", b =>
                {
                    b.HasOne("Touhou_Songs.App.Unofficial.Songs.ArrangementSong", "ArrangementSong")
                        ...
                        .HasConstraintName("fk_tier_list_items_arrangement_songs_arrangement_song_id");

                    b.HasOne("Touhou_Songs.App.Official.OfficialGames.OfficialGame", "OfficialGame")
                        .WithMany()
                        .HasForeignKey("OfficialGameId")
                        .HasConstraintName("fk_tier_list_items_official_games_official_game_id");
